...
export class createTables1658282655414 implements MigrationInterface {
    name = 'createTables1658282655414'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ticket" ("id" uuid NOT NULL, "price" integer NOT NULL, "type" character varying NOT NULL, "observations" character varying, "amount" integer, "amount_left" integer, "eventId" uuid, CONSTRAINT "PK_d9a0835407701eb86f874474b7c" PRIMARY KEY ("id"))`);
